...
public class MyCommentListServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      request.setAttribute("commentList", commentService.listByWriter((User)request.getSession().getAttribute("loginUser")));
      request.getRequestDispatcher("/mypage/commentlist.jsp").include(request, response);
    } catch (Exception e) {
