...
@WebServlet("/follow/user/delete")
public class FollowDeleteUserServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      if (followService.deleteUser(follow) == 0) {
        throw new Exception("이미 팔로우하고 있지 않은 유저입니다.");
      }
