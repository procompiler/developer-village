...
<c:choose>
	...
	<c:otherwise>
		<div class="card text-center user-info mt-5">
			<div class="card-body">
				...
				<a class="card-link" href="../follow/userList">팔로잉
					${loginUser.followingCount}</a> 
			   <a class="card-link" href="../follow/followerList">팔로워 ${loginUser.followerCount}</a>
		...
		<br>
		<a class="btn btn-outline-primary" href="../article/feed">피드</a>
		<a class="btn btn-outline-primary"
