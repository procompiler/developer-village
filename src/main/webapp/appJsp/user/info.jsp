									...
									<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
										<c:choose>
											<c:when test="${user.no != loginUser.no && null ne user}">
												<img src='../../upload/user/${user.photo}_160x160.jpg' alt='[${user.photo}.jpg]'>
												<c:choose>
													<c:when test="${followed}">
														<a class="btn btn-outline-danger" href="../follow/deleteUser?followeeNo=${user.no}">언팔로우</a>
													</c:when>
													<c:otherwise>
														<a class="btn btn-primary" href="../follow/addUser?followeeNo=${user.no}">팔로우</a>
													</c:otherwise>
												</c:choose>
												<br>
												...
												<a class="btn btn-outline-primary" href="../article/writtenList?no=${user.no}">작성게시글</a>
												<a class="btn btn-outline-primary" href="../comment/writtenList?no=${user.no}">작성댓글</a>
											</c:when>
												...
												<div class="card text-center user-info mt-5">
													<div class="card-body">
														<img class="card-img-top rounded-circle"
															src='../../upload/user/${loginUser.photo}_100x100.jpg' alt='[${loginUser.nickname}]' /> <a
														...
														<a class="card-link" href="../follow/userList">팔로잉
															${loginUser.followingCount}</a> <a class="card-link" href="../follow/followerList">팔로워
															${loginUser.followerCount}</a>
												...
												<div class="row mt-4">
													<div class="col">
														<div class="list-group">
															<a class="list-group-item" href="../article/writtenList?no=${loginUser.no}">작성게시글</a>
															<a class="list-group-item" href="../article/feed">피드</a>
															<a class="list-group-item" href="../comment/writtenList?no=${loginUser.no}">작성댓글</a>
															<a class="list-group-item" href="../follow/tagList">팔로잉 태그</a>
															<a class="list-group-item" href="../follow/userList">팔로잉 유저</a>
															<a class="list-group-item" href="../follow/followerList">팔로워</a>
															<a class="list-group-item" href="../bookmark/list">북마크</a>
															<a class="list-group-item" href="../collect/list">뱃지</a>
														</div>
													</div>
													<div class="col-8">
											</c:otherwise>
